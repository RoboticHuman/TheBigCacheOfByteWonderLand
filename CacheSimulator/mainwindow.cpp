      ...
      ui(new Ui::MainWindow)
{
   ...
   QVector<int> hello;
    ...
    //     table1->addScrollBarWidget(ui->verticalScrollBar1,Qt::AlignRight);
        ...
        table1->horizontalHeader()->setDefaultSectionSize( 120 );
        ...
        table2->horizontalHeader()->setDefaultSectionSize( 120 );
        ...
        table3->horizontalHeader()->setDefaultSectionSize( 120 );
        ...
        table4->horizontalHeader()->setDefaultSectionSize( 120 );
